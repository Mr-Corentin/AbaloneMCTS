...
#         for y in range(9):
#             for x in range(9):
#                 if get_cell_content_jax(game.board, x, y) in ['W', 'B']:
#                     game.board[y][x] = 0
#         for color in ['W', 'B']:
...
#         assert get_cell_content_jax(game.board, x, y) == 'W', f"Expected W at ({x}, {y})"
#     for x, y in expected_black:
#         assert get_cell_content_jax(game.board, x, y) == 'B', f"Expected B at ({x}, {y})"
...
#     for x, y in expected_positions:
#         assert get_cell_content_jax(game.board, x, y) == 'W', f"Expected W at ({x}, {y}), but found {get_cell_content_jax(game.board, x, y)}"
